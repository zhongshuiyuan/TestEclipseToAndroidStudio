...
public class Search_1 extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		vs = (ViewStub) findViewById(R.id.loadsearch);
		...
		radioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener()
		{
			...
			public void onCheckedChanged(RadioGroup group, int checkedId)
			{
				...
				RadioButton rb = (RadioButton) Search_1.this.findViewById(id);
...
//					linearDanYuan.setVisibility(View.GONE);
				...
				//Toast.makeText(Search_1.this, type+"", Toast.LENGTH_SHORT).show();
			}
		});
		...
		Search_1ChangeLister changeLister = new Search_1ChangeLister();
...
//		linearDanYuan = (LinearLayout) findViewById(R.id.linearDanYuan);
	...
	private class Search_1ChangeLister implements TextWatcher
	{
		@Override
