...
public class OpenFiles
{
	 ...
	 * @param file
	 */
	public static void openFile(java.io.File file, Activity activity)
	{
		...
		{
			MessageBox.showMessage(activity, "文件", "打开文件错误，原因：" + ex.getMessage());
			//Toast.makeText(activity, "打开文件错误，原因：" + ex.getMessage(), Toast.LENGTH_LONG).show();
		}
	}
