package com.eruntech.crosssectionview.widgets.datagrid.libs.adapters;
 ...
 * set.
 * 
 * @author Brais Gabín (InQBarna), Qin Yuanyi
 * @see TableFixHeaders
 */
public interface TableAdapter {
	 ...
	 *            it is the header.
	 * @return An integer representing the background resource of View. Two
	 *         views should share the same background resource if one can be
	 *         converted to the other in
